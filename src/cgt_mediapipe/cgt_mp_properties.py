...
class MP_PG_Properties(bpy.types.PropertyGroup):
    ...
    # endregion
    mov_body_data_path: bpy.props.StringProperty(
        name="Json Path",
        description="File body path to .json file.",
        default="*.json",
        options={"HIDDEN"},
        maxlen=1024,
        subtype="FILE_PATH",
    ...
    text_input_thai: bpy.props.StringProperty(
        name="Text Input Thai",
        description="Text input in Thai language.",
        default="",
        maxlen=1024,
        subtype="NONE",
    )
...
def register():
    ...
    bpy.types.Scene.cgtinker_mediapipe = bpy.props.PointerProperty(
        type=MP_PG_Properties
    )
